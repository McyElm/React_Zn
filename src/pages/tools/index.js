            ...
            <div className="tools-wrap">
                ...
                <div className="m_q_2" id="box2">
                    ...
                    <div className="con">
                        ...
                        <div className="text text2">该软件主要针对单热源、枝状管网在不同室外参数时进行的供热系统设计工程、改扩建工程、运行工况及事故工况下管网的水力特性的模拟计算分析，为供热系统提供可靠的决策服务。软件包含较为完整的管道、水泵、调节阀、其他局部阻力元件类型库，同时含有常用热网计算参数数据库。</div>
